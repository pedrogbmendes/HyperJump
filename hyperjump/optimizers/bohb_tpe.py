...
from hyperjump.optimizers.config_generators.bohb_tpe import BOHB_TPE as CG_BOHB

class BOHB_TPE(Master):
	...
	def get_next_iteration(self, iteration, iteration_kwargs={}, hyperjump=False):
		...
		return(SuccessiveHalving(HPB_iter=iteration, num_configs=ns, budgets=self.budgets[(-s-1):], config_sampler=self.config_generator, **iteration_kwargs))
