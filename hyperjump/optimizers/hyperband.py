...
from hyperjump.optimizers.config_generators import RandomSampling


class HyperBand(Master):
    def __init__(self, configspace=None,
                 eta=3, min_budget=0.01, max_budget=1, type_exp="fake", seed=0, configspaceList=None,
                 **kwargs):
        """
        ...
        super().__init__(config_generator=RandomSampling(configspace, incumbent=[], incumbent_value=-1,
                                                         min_budget=min_budget, max_budget=max_budget,
                                                         type_exp=type_exp, seed=seed,configspaceList=configspaceList), **kwargs)
