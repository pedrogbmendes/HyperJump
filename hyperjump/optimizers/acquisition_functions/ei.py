...
from hyperjump.optimizers.acquisition_functions.base_acquisition import BaseAcquisitionFunction
...
class EI_models(BaseAcquisitionFunction):

    def __init__(self, model, cost_model, par=0.0):
        ...
        super(EI_models, self).__init__(model)
        self.par = par
