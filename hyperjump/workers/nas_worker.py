...
class MnistNasWorker(Worker):
    ...
    def getVal(self, config, budget):
        ...
        for kk in self.data.keys():
            ...
            if conf['vm_flavor'] == config_with_budgets['vm_flavor'] \
                        ...
                        and conf['network'] == config_with_budgets['network']\
    ...
    def get_configspace(seed=1000):
        ...
        cs.add_hyperparameters([vm_flavor, batch_size, learning_rate, num_cores, synchronism, network])
